# ColorPalette Theme Editor

You can color all windows and panels by choosing a single background color. And it provides easy access to several frequently used color options.



-------------------------------------------------------

Prerequisites :  Blender 5.0.0 ≥
